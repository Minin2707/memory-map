final class MemoryPhotoPreview {
  factory MemoryPhotoPreview({
    ...
    return MemoryPhotoPreview._(
      mediaId: mediaId,
      thumbnailPath: thumbnailPath,
    );
  }

  const MemoryPhotoPreview._({
  ...
  @override
  String toString() => 'MemoryPhotoPreview(hasThumbnailPath: true)';
